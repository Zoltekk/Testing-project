...
def test_cart_total(get_driver):
    ...
    assert "Blue Top" in driver.find_element(By.XPATH, AECartLocators.cart_item_1).text
    assert "Men Tshirt" in driver.find_element(By.XPATH, AECartLocators.cart_item_2).text
